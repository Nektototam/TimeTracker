              ...
              <div className="rounded-2xl border border-border bg-card p-6 shadow-sm">
                ...
                <div className="space-y-4">
                  ...
                  {weekData && weekData.projectSummaries.length === 0 && (
                    <div className="py-6 text-center text-sm text-muted-foreground">Нет данных о проектах</div>
                  )}
                </div>
              </div>

              <div className="space-y-4">
                <h2 className="text-lg font-semibold text-foreground">Недавняя активность</h2>
                  ...
                  <div className="space-y-3">
                    {recentEntries.map((entry, index) => (
                      <div
                        ...
                        style={{ marginBottom: index !== recentEntries.length - 1 ? '12px' : '0' }}
                      >
